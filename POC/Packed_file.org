...
#+begin_src c :tangle srcs/elf/packer/elf_packer.c :mkdirp yes
  ...
  //cmn/math.c
  /* static size_t align_down(uint64_t size, uint64_t alignment) */
  /* { */
  /* 	return ((size / alignment) * alignment); */
  /* } */
  static size_t align_up(uint64_t size, uint64_t alignment)
  {
  ...
  // I leave it here
  //cmn/invalid.c
  static bool invalid_read(int fd, void *ptr, size_t len)
  {
      return (read(fd, ptr, len) != (ssize_t)len);
  }

  static bool invalid_write(int fd, void *ptr, size_t len)
  {
      return (write(fd, ptr, len) != (ssize_t)len);
  }

  static bool invalid_buffer(t_buffer *buf)
  {
      return (!buf->data || !buf->len);
  }

  /* static bool invalid_aes(t_aes128_key *key) */
  /* { */
  ...
  //cmn/buffer.c
  static t_buffer alloc_concat_buffers(const t_buffer *a, const t_buffer *b)
  {
  	t_buffer concat;
  ...
  //elf/analysis.c
  /* static size_t elf_is_gnu_stack_phdr(t_elf_h *ehdr, unsigned char class, uint64_t phnum) */
  /* { */
  /*     t_elf_ph phdr; */
  /*     uint64_t i; */
  ...
  static size_t elf_get_gnu_stack_phdr_ndx(const t_elf_h *ehdr, unsigned char class, uint64_t phnum)
  {
      t_elf_ph phdr;
      uint64_t i;
  ...
  static void apply_patches_to_buffer_with_patch_desc(t_buffer *stage1,
  	const t_arch arch,
  ...
  // elf/check valid for execution
  /* size_t elf_get_va(t_elf_ph *phdr, size_t phnum, unsigned char class) */
  /* { */
  /* 	size_t min_va; */
  /* 	size_t max_va; */
  /*     size_t p_va; */
  ...
  /* 	while (phnum--) */
  /* 	{ */
  /* 		if (elf_get_program_header_type(&phdr[phnum], class) != PT_LOAD) */
  /* 			continue; */
  /* 		p_va = elf_get_program_header_vaddr(&phdr[phnum], class); */
  /* 		if (p_va < min_va) */
  /* 			min_va = p_va; */
  /* 		seg_end = p_va + elf_get_program_header_memsz(&phdr[phnum], class); */
  /* 		if (seg_end > max_va) */
  /* 			max_va = seg_end; */
  /* 	} */

  /* 	min_va = align_down(min_va, 0x1000); */
  /* 	max_va = align_up(max_va, 0x1000); */
  /* 	return (max_va - min_va); */
  /* } */
  /* #include <sys/resource.h> //rlimit, getrlimit */
  /* //Valid VA */
  /* bool elf_invalid_va_len(t_elf_ph *phdr, size_t phnum, unsigned char class, size_t s1_len, size_t s2_len) */
  /* { */
  /* 	const size_t required_va = elf_get_va(phdr, phnum, class) + s1_len + 2 * s2_len; */
  /* 	struct rlimit rl; */

  /* 	getrlimit(RLIMIT_AS, &rl); */
  /* 	return (rl.rlim_cur != RLIM_INFINITY && required_va > rl.rlim_cur); */
  /* } */
  ...
  static bool valid_cpu_x86(void)
  {
  	unsigned int eax;
  	unsigned int ebx;
  	unsigned int ecx;
...
(defun my-c-make-function-static ()
  "Insert 'static' at beginning of current C function and move to next."
  (interactive)
  (c-beginning-of-defun)
  (unless (looking-at-p "\\s-*static\\b")
    (insert "static "))
  (c-end-of-defun)
  (c-beginning-of-defun))
