...
#+begin_src c :tangle srcs/elf/packer/elf_packer.c :mkdirp yes
  ...
  /* void stage1_fill_patches(t_buffer *stage1, */
  /*                          const t_stage1_ctx *ctx,//Just use arch */
  /*                          const t_patch_desc *patches_desc, */
  /*                          size_t patch_count, */
  /*                          const t_insertion *inserts, */
  /*                          size_t insert_count) */
  /* { */
  /*     for (size_t i = 0; i < patch_count; ++i) */
  /*     { */
  /*         uint32_t final_off = compute_patch_offset(ctx->arch, */
  /*                                                   (ctx->arch == ARCH_X64) ? patches_desc[i].base_off_x64 */
  /*                                                                           : patches_desc[i].base_off_x86, */
  /*                                                   inserts, insert_count); */

  /*         if (patches_desc[i].value && patches_desc[i].len) */
  /*             ft_memcpy(stage1->data + final_off, patches_desc[i].value, patches_desc[i].len); */
  /*     } */
  /* } */
...
***** TODO Move to the end s1 open
****** x64
****** x86
***** PLAN When s1 fine pass to s2 open
****** x64
****** x86
***** HOLD Don't create Functions if just one call or less than 5 B excluded ret instruction.
****** _write
******* x86
******* x64
****** _read
