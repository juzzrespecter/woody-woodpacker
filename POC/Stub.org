...
#+begin_src asm :tangle payload/x64/stage1.s :mkdirp yes
  ...
  .return_crypt_compress_addr:
  	...
  	mov rdx, 	0xfefffffffffff000	;[rsp] size_s2_elf, fd, size_stage1, vaddr stage1
  	sub rsp, rdx
  	push rsp		;dest
  	pop rdi
...
* Working on it 
** DONE Easy to modify payload.
CLOSED: [2025-10-30 Thu 08:29]
*** DONE Change payload pos, and update s1 & s2.
CLOSED: [2025-10-30 Thu 08:29]
**** DONE x86
***** DONE s1
***** DONE s2
